...
exports.edit = (options) => {
    ...
    server.listen(port, hostname, () => {
        ...
        editorUrl = util_1.default.format('http://%s:%d/?url=/oas/spec' + options.file, hostname, port);
        const editApiUrl = util_1.default.format('http://%s:%d/oas/spec' + options.file, hostname, port);
